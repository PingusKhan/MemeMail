...
def give_url(topic:str, number:int):
    urlgen = "http://api.giphy.com/v1/gifs/search?q="+str(topic).rstrip().lower().replace(" ","+")+"+meme&api_key=Oroe1G0gBq2z6n2lD0fA5r2UC3SNA9u6&limit="+str(number)
